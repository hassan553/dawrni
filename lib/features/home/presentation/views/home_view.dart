...
class _HomeViewState extends State<HomeView> {
      ...
      child: BlocBuilder<CompaniesBloc, BaseState<CompaniesEntity>>(
        builder: (context, state) {
          if (state.isLoading) {
            ...
            return FailureComponent(failure: state.failure, retry: () => getCompanies(context),);
            ...
            return SmartRefresher(
              ...
              child: ListView(
                children: [
                  ...
                  const SizedBox(height: 20),
                  ...state.data?.companies.map((e) => CompanyCard(company: e)).toList() ?? [],
                  if(false)
                    Row(
  ...
  void getCompanies(BuildContext context, {bool refresh = false, String searchQuery = ''}) {
    context
        .read<CompaniesBloc>()
  ...
  SizedBox buildCategories() {
    return SizedBox(
          ...
          child: CarouselSlider(
              items: AppConstants.categories.map((e) => CategoryCard(category: e)).toList(),
