                ...
                BlocConsumer<PhoneAuthCubit, PhoneAuthState>(
                  ...
                  builder: (context, state) => PinCodeTextField(
                    ...
                    onCompleted: (value) {
                      if (value.length == 6) {
                        if (isCompany) {
                          PhoneAuthCubit.get(context).submitCompanyOTP(
                              value,
                              'hassan',
                              widget.phone,
                              PhoneAuthCubit.get(context).selectedValue,
                              'lll');
                        } else {
                          PhoneAuthCubit.get(context)
                              .submitClientOTP(value, 'hassan', widget.phone);
                        }
                      }
                    },
                  ),
        ...
        : CustomButton(
            function: () {
              if (isCompany) {
                ...
                PhoneAuthCubit.get(context).submitClientOTP(
                    codeController.text, 'hassan', widget.phone);
              }
            },
            color: AppColors.primaryColor,
            textColor: AppColors.white,
