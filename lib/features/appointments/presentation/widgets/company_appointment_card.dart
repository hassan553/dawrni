...
class CompanyAppointmentCard extends StatelessWidget {
  ...
  const CompanyAppointmentCard({Key? key, required this.appointment}) : super(key: key);
    ...
    return Container(
      ...
      child: ElevatedButton(
        ...
        onPressed: appointment.checked ? () {} : () async {
          ...
          //   if(value) {
          //     context.read<DeleteCompanyAppointmentBloc>().add(DeleteCompanyAppointmentButtonPressedEvent(id: appointment.id));
          //   }
          // });
        },
        child: Padding(
