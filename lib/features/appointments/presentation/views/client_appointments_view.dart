...
import 'package:dawrni/features/appointments/presentation/widgets/client_appointment_card.dart';
    ...
    return BlocListener<AppConfigBloc, AppConfigState>(
      ...
      child: Padding(
        ...
        child: BlocListener<DeleteClientAppointmentBloc, BaseState<void>>(
          ...
          child: BlocBuilder<ClientAppointmentsBloc,
              BaseState<ClientAppointmentsEntity>>(
            builder: (context, state) {
              if (state.isLoading) {
                ...
                return FailureComponent(
                    ...
                    retry: () => getClientAppointments(context));
              } else if (state.isSuccess) {
                return SmartRefresher(
                  controller:
                      context.read<ClientAppointmentsBloc>().refreshController,
                  onRefresh: () =>
                      getClientAppointments(context, refresh: true),
                  ...
                  child: ListView(
                    children: [
                      ...
                      ...state.data?.appointments
                              .map((e) => ClientAppointmentCard(appointment: e))
                              .toList() ??
                          [],
